...
public class TransferOwnershipStyle: BaseStyle {
    ...
    private(set) var transferButtonTint = CometChatTheme.palatte.primary
    private(set) var transferButtonFont = CometChatTheme.typography.title2
    ...
    @discardableResult
    public func set(transferButtonFont: UIFont) -> Self {
        self.transferButtonFont = transferButtonFont
        return self
    }
    
    @discardableResult
    public func set(transferButtonTint: UIColor) -> Self {
        self.transferButtonTint = transferButtonTint
        return self
    }
