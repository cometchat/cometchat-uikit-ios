...
public class AddMembersStyle: BaseStyle {
    ...
    private(set) var addButtonTint = CometChatTheme.palatte.primary
    private(set) var addButtonFont = CometChatTheme.typography.title2
    ...
    @discardableResult
    public func set(addButtonFont: UIFont) -> Self {
        self.addButtonFont = addButtonFont
        return self
    }
    
    @discardableResult
    public func set(addButtonTint: UIColor) -> Self {
        self.addButtonTint = addButtonTint
        return self
    }
