...
//    }
    ...
    @discardableResult
    @objc public func set(borderColor : UIColor) -> CometChatMeetingBubble {
        self.background.layer.borderColor = borderColor.cgColor
        return self
    }

    @discardableResult
    @objc public func set(borderWidth : CGFloat) -> CometChatMeetingBubble {
    ...
    @objc public func set(userName: String) -> CometChatMeetingBubble {
        if messageAlignment == .leftAligned {
    ...
    @discardableResult
    @objc public func set(messageBubbleAlignment: UIKitConstants.MessageBubbleAlignmentConstants) -> CometChatMeetingBubble {
        switch messageBubbleAlignment {
        case .left:
            name.isHidden = false
