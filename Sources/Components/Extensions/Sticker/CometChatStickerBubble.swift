...
class CometChatStickerBubble: UIStackView {
    ...
    private func customInit() {
        CometChatUIKit.bundle.loadNibNamed("CometChatStickerBubble", owner: self, options:  nil)
    ...
    public func set(style: StickerBubbleStyle) {
