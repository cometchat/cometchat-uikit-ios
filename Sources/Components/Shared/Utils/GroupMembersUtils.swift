...
public class GroupMembersUtils {
    ...
    let kickMember = CometChatGroupMemberOption(id: GroupMemberOptionConstants.kick, title: "KICK_MEMBER".localize(), icon: UIImage(named: "groups-kick.png", in: CometChatUIKit.bundle, compatibleWith: nil)?.withRenderingMode(.alwaysTemplate), backgroundColor: CometChatTheme.palatte.error,  onClick: nil)
    ...
    let unbanMember = CometChatGroupMemberOption(id: GroupMemberOptionConstants.unban, title: "UNBAN_MEMBER".localize(), icon: UIImage(named: "groups-kick.png", in: CometChatUIKit.bundle, compatibleWith: nil)?.withRenderingMode(.alwaysTemplate), backgroundColor: CometChatTheme.palatte.error,  onClick: nil)
    ...
    fileprivate static func allowKickBanUnbanMember(group: Group, groupMember: GroupMember) -> Bool {
    ...
    static func allowScopeChange(group: Group, groupMember: GroupMember) -> Bool {
        let myScope = group.scope
        let groupMemberScope = groupMember.scope
        if group.owner == CometChat.getLoggedInUser()?.uid {
            return true
