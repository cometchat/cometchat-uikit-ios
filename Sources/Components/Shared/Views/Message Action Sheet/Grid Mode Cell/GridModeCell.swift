...
class GridModeCell: UITableViewCell {
    ...
    var actionSheetConfiguration: ActionSheetConfiguration?
    ...
    func set(actionSheetConfiguration: ActionSheetConfiguration?)  {
        self.actionSheetConfiguration = actionSheetConfiguration
    }
...
extension GridModeCell: UICollectionViewDataSource, UICollectionViewDelegate {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        if let actionItem = actionsItems?[safe: indexPath.row] {
            ...
            return configureCell(withTitle: actionItem.text ?? "" , icon: actionItem.leadingIcon ?? UIImage(), tintColor: .white, forIndexPath: indexPath)
