...
public class CometChatGroupActionBubble: UITableViewCell {
    ...
    static var identifier = "CometChatGroupActionBubble"
//    @discardableResult
    ...
    var actionMessage: BaseMessage? {
        didSet {
            ...
            if let action = actionMessage.action {
                ...
                self.set(textColor: CometChatTheme.palatte.accent600)
                self.set(textFont: CometChatTheme.typography.caption1)
                self.set(borderColor: CometChatTheme.palatte.accent200)
