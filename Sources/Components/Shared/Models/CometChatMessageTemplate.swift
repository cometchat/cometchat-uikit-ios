...
public struct CometChatMessageTemplate {
    ...
    public init(category: String, type: String, contentView: ( (_: BaseMessage?, _: MessageBubbleAlignment, _: UIViewController?) -> UIView?)?, bubbleView: ( (_: BaseMessage?, _: MessageBubbleAlignment, _: UIViewController?) -> UIView?)?, headerView: ( (_: BaseMessage?, _: MessageBubbleAlignment, _: UIViewController?) -> UIView?)? , footerView: ( (_: BaseMessage?, _: MessageBubbleAlignment, _: UIViewController?) -> UIView?)?, bottomView: ( (_: BaseMessage?, _: MessageBubbleAlignment, _: UIViewController?) -> UIView?)?, options: ( (_: BaseMessage?, _: Group?, _: UIViewController?) -> [CometChatMessageOption]?)?) {
    ...
    func toString() -> String {
        return "CometChatMessageTemplate{type: \(type), category: \(category), bubbleView: \(String(describing: bubbleView)), headerView: \(String(describing: headerView)), footerView: \(String(describing: footerView)), contentView: \(String(describing: contentView)), bottomView: ,\(String(describing: bottomView)),options: \(String(describing: options))}"
    }
}
