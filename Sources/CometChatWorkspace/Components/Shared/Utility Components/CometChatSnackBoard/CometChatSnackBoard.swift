...
extension CometChatSnackBoard {
    ...
    public static func display(message: String, mode: SnackboardLayoutAppearance, duration: CometChatSnackBoardDuration) {
    ...
    public static func show(message: String, mode: SnackboardLayoutAppearance, duration: CometChatSnackBoardDuration) {
        let view = MessageView.viewFromNib(layout: .messageView)
        view.configureContent(title: message, body: "" , iconImage: nil, iconText: nil, buttonImage: nil, buttonTitle: "", buttonTapHandler: { _ in CometChatSnackBoard.hide() })
        view.configureTheme(mode, iconStyle: .default)
        var config = CometChatSnackBoard.defaultConfig
    ...
    public static func showErrorMessage(for error: CometChatException) {
        ...
        if error.errorCode == "ERROR_INTERNET_UNAVAILABLE" {
            CometChatSnackBoard.display(message:  "ERROR_INTERNET_UNAVAILABLE".localize() , mode: .error, duration: .short)
        }else{
            CometChatSnackBoard.display(message:  "SOMETHING_WENT_WRONG_ERROR".localize() , mode: .error, duration: .short)
        }
    }
}
