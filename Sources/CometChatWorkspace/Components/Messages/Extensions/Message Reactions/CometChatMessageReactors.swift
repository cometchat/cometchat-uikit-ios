...
class CometChatMessageReactors: UITableViewController {
    ...
    private func setupTableView() {
        let CometChatUserListItem  = UINib.init(nibName: "CometChatUserListItem", bundle: CometChatUIKit.bundle)
...
//            cell.avatar.setAvatar(avatarUrl: user?.avatar ?? "", with: user?.name ?? "")
//            return cell
//        }
        return staticCell
    }
