...
class CometChatContextMenuDismissing: NSObject, UIViewControllerAnimatedTransitioning {

    private let item: CometChatContextMenu.Item

    init(item: CometChatContextMenu.Item) {
        self.item = item
    }
