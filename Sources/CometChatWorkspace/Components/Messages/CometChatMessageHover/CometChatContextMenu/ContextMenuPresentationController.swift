...
protocol CometChatContextMenuPresentationControllerDelegate: class {
    func willDismiss(presentationController: CometChatContextMenuPresentationController)
}

class CometChatContextMenuPresentationController: UIPresentationController {

    weak var contextDelegate: CometChatContextMenuPresentationControllerDelegate?
    let item: CometChatContextMenu.Item
    var keyboardSpace: CGFloat = 0

    init(presentedViewController: UIViewController, presenting presentingViewController: UIViewController?, item: CometChatContextMenu.Item) {
        self.item = item
