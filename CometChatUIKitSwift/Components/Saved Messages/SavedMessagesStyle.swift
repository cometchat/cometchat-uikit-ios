...
public struct SavedMessagesStyle: ListBaseStyle, ListItemStyle {
    ...
    // Font for the empty state title (when no saved messages are present)
    ...
    // Background for the per-row unsave swipe action
    public var unsaveActionBackgroundColor: UIColor = CometChatTheme.errorColor
