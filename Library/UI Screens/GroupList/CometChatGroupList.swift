...
public class CometChatGroupList: UIViewController, CometChatMessageDelegate {
    ...
    private func setupNavigationBar(){
        if navigationController != nil{
            ...
            let closeButton = UIBarButtonItem(image: createGroupImage, style: .plain, target: self, action: #selector(didCreateGroupPressed))
    ...
    @objc func didCreateGroupPressed(){
        ...
        createGroup.set(title: "Create Group", mode: .automatic)
