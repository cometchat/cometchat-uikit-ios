...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "CometChatUIKitSwift",
            url: "https://library.cometchat.io/ios/v4.0/xcode15/CometChatUIKitSwift_4_3_19.xcframework.zip",
            checksum: "8e399d812bcf28220eb66bfe7665896b21644694eeadeeeeae1ca7564ce82a61"
        )
    ]
)
