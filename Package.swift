...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "CometChatUIKitSwift",
            url: "https://library.cometchat.io/ios/v5.0/xcode16/CometChatUIKitSwift_5_1_1.xcframework.zip",
            checksum: "9905bfe733d22a365dc72142f9776888dde566b7d23dc2731839206b710c6878"
        )
    ]
)
