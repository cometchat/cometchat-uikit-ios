...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "CometChatUIKitSwift",
            url: "https://library.cometchat.io/ios/v4.0/xcode15/CometChatUIKitSwift_4_3_14.xcframework.zip",
            checksum: "89154cdfe15b4fa42a6f19f96eb600e12f881618fffeab90124970231632c3b3"
        )
    ]
)
