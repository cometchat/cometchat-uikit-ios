...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "CometChatUIKitSwift",
            url: "https://library.cometchat.io/ios/v5.0/xcode16/CometChatUIKitSwift_5_1_2.xcframework.zip",
            checksum: "488bc7ef7b2968838135528ddf9785e3b9df6c5f2ae9ae343a3a413e35608dbe"
        )
    ]
)
