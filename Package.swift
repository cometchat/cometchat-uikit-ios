...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "CometChatUIKitSwift",
            url: "https://library.cometchat.io/ios/v5.0/xcode16/CometChatUIKitSwift_5_0_8.xcframework.zip",
            checksum: "204a4f9b78735b018f93fd78f895da84f0f08ad6d86895feab1d6f7bbec797f3"
        )
    ]
)
