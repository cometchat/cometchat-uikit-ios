...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "CometChatUIKitSwift",
            url: "https://library.cometchat.io/ios/v4.0/xcode15/CometChatUIKitSwift_4_2_1.xcframework.zip",
            checksum: "736693d923978be5d80efce54830291b0f2923cd6a928548805ed7bc2421bf15"
        )
    ]
)
